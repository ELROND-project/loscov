...
def QQ_LOS_mean(chi):
    ...
    """
    WW = np.mean(Q_LOS(chi, chid, chis) * Q_LOS(chi, chid, chis))
...
def get_cl_L(chimax, lmax, nl):
    ...
    kernel2 = Q_LOS_mean_intp(chis)**2 / chis**2
    kernel1 = QQ_LOS_rms_intp(chis)**2 / chis**2
