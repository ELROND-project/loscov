...
def Q_os_mean(chi, b):
    ...
    def integrand(z_source):
        ...
        return p_b*Q_os(chi,chi_source) 
...
def QQ_os_mean(chi, b):
    ...
    def integrand(z_source):
        ...
        return p_b*Q_os(chi,chi_source)*Q_os(chi,chi_source) 
...
def get_cl_E(b1, b2, chimax, lmax, nl):
    ...
    kernel2 = Q_os_mean_intp[b1](chis)*Q_os_mean_intp[b2](chis) / chis**2
    kernel1 = QQ_os_rms_intp[b1](chis)*QQ_os_rms_intp[b2](chis) / chis**2 
